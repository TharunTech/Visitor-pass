...
<body class="u-body u-xxl-mode">
	...
	<h1 style="padding-top: 20px; padding-bottom: 20px;"><b><u>Preview Image</u></b></h1>
	</div>
        <div class="container-fluid" id="id_tt">
            <div class="row text-center align-items-center justify-content-center" >
                  <img src="./uploadPhoto/22.png" alt="">
                   <img src="./uploadPhoto/temp.jpeg" class="no4" style="top: 255px;"  alt="visitor_pic">
                  <h1 class="name" style="top: 700px; font-size: 28px;">
                  <?php if(isset($_POST['submit'])){
                      $firstName=$_POST['Name_1'];
                        echo $firstName."<br />";
                      }?></h1> 
                  <h1 class="number" style="top: 740px; font-size: 20px;">
                    <?php if(isset($_POST['submit'])){
